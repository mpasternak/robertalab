...
public class SimulationVisitor extends RobotSimulationVisitor<Void> implements MbedAstVisitor<Void> {
    ...
    public Void visitPinGetValueSensor(PinGetValueSensor<Void> pinValueSensor) {
        this.sb.append("createPinGetValueSensor(CONST." + pinValueSensor.getMode().getValues()[0]);
        this.sb.append(", " + pinValueSensor.getPort().getValues()[1] + ")");
        return null;
    }
    ...
    public Void visitPinWriteValueSensor(PinWriteValue<Void> pinWriteValueSensor) {
        ...
        this.sb.append(", " + pinWriteValueSensor.getPort().getValues()[1] + ", ");
        this.sb.append(pinWriteValueSensor.getMode());
        this.sb.append(end);
        return null;
    }
